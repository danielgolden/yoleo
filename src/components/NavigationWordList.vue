...
export default defineComponent({
  emits: ["updateCurrentWordList", "newWordSelected", "updateWordListName", "deleteWord"],
  data() {
    return {
      hidden: false,
      active: false,
  ...
  watch: {
    editMode(newValue, oldValue) {
      if (newValue) {
        (this.$refs.wordListNameText as HTMLElement).focus();
        this.hidden = false;
      }
    },
  ...
  :class="
    ...
    >
      ...
      >
        ...
        <span ref="wordListNameText" :class="{'word-list-name-text': true, 'word-list-name-text-editable': editMode}" :contenteditable="editMode">
