...
<template>
  ...
  >
    <svg class="failure-icon-static icon-static button-icon" v-if="activated !== 'failure'" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.72594 1.12235C3.00702 0.403431 1.84142 0.403431 1.1225 1.12235C0.403583 1.84127 0.403583 3.00687 1.1225 3.72579L8.39635 10.9996L1.1225 18.2735C0.403583 18.9924 0.403583 20.158 1.1225 20.8769C1.84142 21.5958 3.00702 21.5958 3.72594 20.8769L10.9998 13.6031L18.2736 20.8769C18.9926 21.5958 20.1582 21.5958 20.8771 20.8769C21.596 20.158 21.596 18.9924 20.8771 18.2735L13.6032 10.9996L20.8771 3.72579C21.596 3.00687 21.596 1.84127 20.8771 1.12235C20.1582 0.403431 18.9926 0.403431 18.2736 1.12235L10.9998 8.3962L3.72594 1.12235Z" fill="var(--color-text-tertiary)"/>
    </svg>
  ...
  >
    ...
    <svg class="success-icon-activated icon-activated" v-if="activated === 'success'" width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M39.9608 20.3244C40.6797 19.6055 40.6797 18.4399 39.9608 17.721C39.2419 17.0021 38.0763 17.0021 37.3574 17.721L22.7045 32.3738L16.6426 26.3119C15.9237 25.593 14.7581 25.593 14.0392 26.3119C13.3203 27.0308 13.3203 28.1964 14.0392 28.9154L21.4028 36.279C22.1217 36.9979 23.2873 36.9979 24.0063 36.279L39.9608 20.3244Z" fill="var(--color-text-attention-success)"/>
      <path fill-rule="evenodd" clip-rule="evenodd" d="M27 0C12.0883 0 0 12.0883 0 27C0 41.9117 12.0883 54 27 54C41.9117 54 54 41.9117 54 27C54 12.0883 41.9117 0 27 0ZM3.68182 27C3.68182 14.1217 14.1217 3.68182 27 3.68182C39.8783 3.68182 50.3182 14.1217 50.3182 27C50.3182 39.8783 39.8783 50.3182 27 50.3182C14.1217 50.3182 3.68182 39.8783 3.68182 27Z" fill="var(--color-text-attention-success)"/>
    </svg>
  </button>
</template>
...
@media (hover: hover) {
  .success-outcome-button:hover {
     background-color: var(--color-bg-attention-success);
  }
  
  .failure-outcome-button:hover {
     background-color: var(--color-bg-attention-failure);
  }

  .word-outcome-button:hover .success-icon-static path {
    fill: var(--color-text-attention-success);
  }
  .word-outcome-button:hover .failure-icon-static path {
    fill: var(--color-text-attention-failure);
  }
